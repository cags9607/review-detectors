...
The only non-null values emitted in `ai_pred_label` are:
...
Internal conditions such as short text, empty inference output, or an AI-detector error are not exposed as label categories; they produce null AI prediction fields instead.
